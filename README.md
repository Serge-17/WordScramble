...
<img src="WordScramble/Assets.xcassets/WordScramble.png" alt="Simulator Screenshot - iPhone 16 Pro" width="300" />
...
1. **Клонируйте репозиторий:**
   ```bash
   git clone https://github.com/Serge-17/WordScramble.git
...
5. **Перезапуск игры:**
- Нажмите кнопку "New Word", чтобы начать новую игру с другим корневым словом.
6. **Ошибки:**
